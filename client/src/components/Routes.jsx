    ...
    <Switch>
      ...
      
      {
        /*
          ...
          ANSWER HERE:
          * We are using what is called Javascript Ternary logic.
          * If user is authenticated user it will direct user to component requested. However if user is not authenticated it will redirect user to index page.
          * Code is using Render props to pass down property which in our case is app.js
        */
      }
